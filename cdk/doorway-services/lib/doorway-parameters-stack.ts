...
export class DoorwayParametersStack extends cdk.Stack {
  constructor(
    ...
    const ASSET_FS_PRIVATE_CONFIG_s3_BUCKET = new StringParameter(this, "privateConfigBucket", {
    ...
    const USE_SECURE_DOWNLOAD_PATHWAY = new StringParameter(this, "useSecureDownloadPathway", {
